      ...
      <div className="min-h-screen bg-background flex overflow-x-hidden">
        ...
        <aside className={"hidden lg:flex flex-col border-r border-border bg-card fixed h-full transition-all " + (collapsed ? 'w-16' : 'w-64')}>
          ...
          <div className="p-4 border-t border-border">
            ...
            >
              <div className={cn(
                "h-10 w-10 rounded-full bg-primary/10 flex items-center justify-center overflow-hidden",
                collapsed && "mx-auto"
              )}>
                {user?.user_metadata?.avatar_url ? (
                  // eslint-disable-next-line jsx-a11y/img-redundant-alt
                  <img src={user.user_metadata.avatar_url} alt="avatar" className="h-10 w-10 object-cover rounded-full" />
                ) : (
            ...
            <div className="flex items-center justify-between">
              ...
              <Link to={user ? "/settings" : "/auth"}>
                <div className="h-8 w-8 rounded-full bg-primary/10 flex items-center justify-center overflow-hidden">
                  {user?.user_metadata?.avatar_url ? (
                    <img src={user.user_metadata.avatar_url} alt="avatar" className="h-8 w-8 object-cover rounded-full" />
                  ) : (
