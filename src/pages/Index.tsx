...
import { Search, TrendingUp, Sparkles, Loader2, MapPin, RefreshCw } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8 py-6 lg:py-10">
        ...
        <div className="bg-gradient-to-br from-primary via-primary to-accent rounded-2xl lg:rounded-3xl p-6 lg:p-12 mb-8 text-primary-foreground relative overflow-hidden">
          ...
          <div className="relative max-w-2xl">
            ...
            <h2 className="text-3xl lg:text-5xl font-bold mb-4">{t('app.tagline')} 🇻🇳</h2>
            <p className="text-lg opacity-90 mb-6 max-w-lg">{t('home.explore')}</p>
        ...
        <div className="mb-10">
          <div className="flex items-center justify-between mb-4">
            ...
            <Button variant="ghost" size="sm" onClick={handleRefreshLocation} className="gap-2">
          ...
          {locationError && !nearbyLoading && nearbyPlaces.length === 0 ? (
            ...
            >
              ...
              <p className="text-sm text-primary font-medium">
                {t('messages.press_to_grant_permission')}
              </p>
            </div>
          ) : (
            <PlacesList
